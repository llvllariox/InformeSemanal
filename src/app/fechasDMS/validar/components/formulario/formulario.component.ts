...
export class FormularioFechasDMSValidarComponent implements OnInit {
  ...
  constructor(
    ...
    private router: Router) { 
      ...
      this.fechaInforme = new Date(jsonDataService.getFechaInforme() + '-05T00:00:00');
  }
  ...
  cambiarFecha(event) {
    ...
    this.fechaInforme = new Date(this.formulario.value.fecha + "-05T00:00:00");
        ...
        this.sweetAlerService.mensajeOK('Fechas validadas exitosamente').then(          
          resp => {
            if (resp.value) {
              ...
              this.router.navigateByUrl('/fechasDMS/validar/mostrar');        
            }
          }
        );
    }
