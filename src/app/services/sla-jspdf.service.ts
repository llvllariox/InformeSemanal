  ...
  generaPDF(variables, fecha){
    ...
    return new Promise((resolve, reject) => {
      ...
      doc.autoTable({
        ...
        styles: { fontSize: 8},
        columnStyles: {
          0: {cellWidth: 100, fontStyle: 'bold', fillColor: [217, 217, 217], halign: 'left' },
          1: {cellWidth: 16, fontStyle: 'bold', fillColor: [217, 217, 217] },
          2: {cellWidth: 26, fontStyle: 'bold', fillColor: [217, 217, 217] },
      ...
      if(flagMin==1){
        doc.addImage(this.flecha, 'PNG', 92, yTextoFinal-6, 5, 5)
        doc.text(100, yTextoFinal, 'Bajo la cantidad mínima necesaria de casos para la métrica');
      }

      let altoMin = flagMin==0 ? yTextoFinal : yTextoFinal+11;

      doc.text(10, altoMin, 'Copyright © 2022 Accenture All rights reserved.');

      doc.addImage(this.antena, 'PNG', 92, altoMin-6, 7, 8)
